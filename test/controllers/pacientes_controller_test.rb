...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference("Paciente.count") do
      post pacientes_url, params: { paciente: { leito_internacao: @paciente.leito_internacao, nome: @paciente.nome } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { leito_internacao: @paciente.leito_internacao, nome: @paciente.nome } }
