...
class MedicamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medicamento" do
    assert_difference("Medicamento.count") do
      post medicamentos_url, params: { medicamento: { nome: @medicamento.nome, tipo: @medicamento.tipo } }
    end
  ...
  test "should update medicamento" do
    patch medicamento_url(@medicamento), params: { medicamento: { nome: @medicamento.nome, tipo: @medicamento.tipo } }
